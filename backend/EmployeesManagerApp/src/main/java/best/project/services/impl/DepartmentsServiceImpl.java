...
public class DepartmentsServiceImpl implements DepartmentsService {
	...
	@Override
	public Department findById(Long id) throws NoEntityFoundExeption {
		...
		if (department == null) {
			...
			throw new NoEntityFoundExeption("Could not find department by id: " + id);
		}
		return department;
	}

	@Override
	public Department findByEmployeeId(Long employeeId) throws NoEntityFoundExeption {
		...
		if (department == null) {
			...
			throw new NoEntityFoundExeption("Could not find department by employee id: " + employeeId);
		}
		return department;
	}

	@Override
	public List<Department> findAll() throws NoEntityFoundExeption {
		...
		if (departments == null || departments.isEmpty()) {
			...
			throw new NoEntityFoundExeption("Could not find departments in DB");
		}
		return departments;
	}
